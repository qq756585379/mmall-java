## klxc
```
CREATE DATABASE `klxc` DEFAULT character set utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `user` (
  ...
  `role` int(4) DEFAULT '0' COMMENT '角色0-普通用户,1-区域负责人,2-后台管理人员',
  `tab_info` varchar(50) DEFAULT NULL COMMENT 'tabInfo',
